...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40667);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(21243),
    __webpack_require__(98547),
    __webpack_require__(6154),
    __webpack_require__(73778),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(65280),
  __webpack_require__(91779),
  __webpack_require__(41361),
  __webpack_require__(29124),
  __webpack_require__(69910),
  __webpack_require__(31998),
  __webpack_require__(97772),
  
      (__webpack_require__(44444)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(48427)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
  ...
  __webpack_require__(19626),
  
      (__webpack_require__(53752)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(55460)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(88434),
  
      (__webpack_require__(96104)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(18500)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(42563)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(38936)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(36875)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(56647),
  __webpack_require__(90757),
  __webpack_require__(2253),
  __webpack_require__(86842),
  
      (__webpack_require__(62143)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(64106),
  __webpack_require__(94177),
  __webpack_require__(80375),
  
      (__webpack_require__(91883)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
  ...
  __webpack_require__(39368),
  __webpack_require__(62818),
  __webpack_require__(97012),
  __webpack_require__(43545),
  __webpack_require__(23859),
  __webpack_require__(53076),
  __webpack_require__(20157),
  __webpack_require__(18578),
  ...
  switch (page) {
    ...
    case '/tree': {
      baseMods = baseMods.concat([
        __webpack_require__(58292),
  __webpack_require__(43573),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(89370),
  
      (__webpack_require__(28962)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(59030),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(43207),
  __webpack_require__(58292),
  
      (__webpack_require__(50130)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:display-registry',
      ...
      __webpack_require__(34756),
  __webpack_require__(90482),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(89267)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(65426)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(26204).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(50440).IServiceManager);
...
//# sourceMappingURL=8781.406c9c7dfe1a72088597.js.map?v=406c9c7dfe1a72088597