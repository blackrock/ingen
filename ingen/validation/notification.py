...
def email_attributes(params, validation_action, validation_summary):
    ...
    validation_action_to_address = validation_action_attributes.get('validate_action_to_adr')
    ...
    if 'blocker' in str(validation_summary):
        raise ValueError(f"Error while Validating interface file for the columns having severity as blocker")
